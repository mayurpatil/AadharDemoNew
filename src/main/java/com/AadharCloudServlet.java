...
public class AadharCloudServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			name.put("matching-strategy", "exact");
			name.put("name-value", Name);
			demog.put("name", name);
		...
		//url = new URL("http://localhost:8181/auth/raw");
     	url = new URL("http://188.166.254.225:8181/auth/raw");
